...
public class CalendarView extends View implements View.OnTouchListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        surface.width = getResources().getDisplayMetrics().widthPixels-50;
...
//		}
    ...
    private class Surface {
        ...
        private int textColor =0xff767676 ;
        ...
        private int weekdatColor = Color.parseColor("#FFA500");
        ...
        public void init() {
            ...
            Log.d(TAG, "cellHeight:"+cellHeight+".....cellWidth"+cellWidth);
            ...
            Log.d(TAG, "textSize:" + textSize+"...cellHeight"+cellHeight);

            monthPaint.setTextSize(textSize);
            monthPaint.setTypeface(Typeface.DEFAULT_BOLD);
            weekPaint = new Paint();
            weekPaint.setColor(weekdatColor);
//			weekPaint.setAntiAlias(true);
            float weekTextSize = weekHeight * 0.6f;

            weekPaint.setTextSize(19);
            Log.d(TAG, "weekTextSize:" + weekTextSize+"....weekHeight"+weekHeight);
...
//			datePaint.setAntiAlias(true);
            ...
            datePaint.setTextSize(19);
            Log.d(TAG, "cellTextSize:" + cellTextSize + "...cellHeight" + cellHeight);
